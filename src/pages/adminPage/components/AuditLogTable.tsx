                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-5 py-3">
                      <span
                        className={`inline-flex items-center h-[20px] px-2 rounded-full border text-[10px] font-medium capitalize ${
                          TARGET_STYLE[entry.targetType] ?? TARGET_STYLE.file
                        }`}
                      >
                        {entry.targetType}
                      </span>
                    ...
                    <td className="px-5 py-3 text-[12px] text-[#858c87] dark:text-[#6e7672] font-mono">
                      {entry.actorId.slice(0, 8)}…
                    </td>
                    <td className="px-5 py-3 text-[12px] text-[#858c87] dark:text-[#6e7672]">
                      {fmtFull(entry.createdAt)}
                    </td>
                  </tr>
                );
              })}
